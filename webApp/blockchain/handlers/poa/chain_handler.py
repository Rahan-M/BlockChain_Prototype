...
from webApp.blockchain.blockchain_structures.chain.poa.utils import isvalidChain

class PoAChainHandler(BaseHandler):
    ...
    async def handle(self, websocket, msg):
        ...
        async with self.peer.mem_pool_condition:
            for transaction in list(self.peer.mem_pool):
